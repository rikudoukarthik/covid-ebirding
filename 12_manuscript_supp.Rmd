---
title: "Supplementary Material: Birding in the time of COVID"
...
## Exploratory analyses and bootstrapped estimates
...
This is a more quantitative method of analysing whether the majority of districts showed a positive or a negative change. We estimated mean raw change and its 95% CI, by bootstrapping across all the districts `(see S1.1 above)`. If the net change from DUR to AFT was significantly (no overlap of CIs) higher than from BEF to DUR, this would suggest that birding effort or grid coverage was subdued during the pandemic.
