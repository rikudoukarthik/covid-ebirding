...
```{r s_spread_LULC_getMODIS, cache=TRUE, message=FALSE, echo=FALSE, eval=FALSE}
...
```{r s_spread_LULC_analMODIS, cache=TRUE, message=FALSE, echo=FALSE, eval=FALSE}
...
rast <- rast("data/in_LULC_MODIS/in_LULC_MODIS.tif")
plot(rast)
