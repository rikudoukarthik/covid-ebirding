...
```{r s_spread_shp, cache=TRUE, message=FALSE, echo=FALSE, eval=FALSE}
...
temp1 <- data_sub %>% 
  ...
  filter(SAMPLING.EVENT.IDENTIFIER %in%
           sample(unique(SAMPLING.EVENT.IDENTIFIER), 1000))
...
temp <- temp1 %>% column_to_rownames("SAMPLING.EVENT.IDENTIFIER") 
