...
raster::plot(rast_UNU, main = "2kmx2km") 
...
data_UNU <- data0 %>% 
  mutate(URBAN = raster::extract(rast_UNU, cbind(LONGITUDE, LATITUDE)),
         ...
         CELL.ID = cellFromXY(rast_UNU, cbind(LONGITUDE, LATITUDE)))  
...
(ggplot(filter(urban_sw, STATE == "Maharashtra"), 
    ...
    labs(title = "Maharashtra",
         x = "Month", y = "Proportion of urban lists"))) +
plot_layout(guides= "collect") -> s_spread_LULC_MODIS
...
(ggplot(data_spread, aes(MONTH, U.LISTS, colour = COVID)) + 
    scale_x_continuous(breaks = 1:12) + 
    geom_point(size = 3, position = position_dodge(0.5)) +
  ...
  (ggplot(data_spread, aes(MONTH, NU.LISTS, colour = COVID)) + 
    scale_x_continuous(breaks = 1:12) + 
    geom_point(size = 3, position = position_dodge(0.5)) +
    geom_errorbar(aes(ymin = NU.CI.L, ymax = NU.CI.U), 
                  size = 1.25, width = 0.4, position = position_dodge(0.5)) +
    scale_colour_manual(values = covid_palette) +
    labs(title = "Non-urban",
         x = "Month", y = "No. of lists")) +
  plot_layout(guides = "collect") +
  plot_annotation(
    title = "Birding effort in lists at 2kmx2km resolution"
...
(ggplot(cells_UNU, aes(MONTH, U.CELLS, colour = COVID)) + 
    scale_x_continuous(breaks = 1:12) + 
    geom_point(size = 3, position = position_dodge(0.5)) +
    geom_errorbar(aes(ymin = U.CI.L, ymax = U.CI.U), 
                  size = 1.25, width = 0.4, position = position_dodge(0.5)) +
  ...
  (ggplot(cells_UNU, aes(MONTH, NU.CELLS, colour = COVID)) + 
    scale_x_continuous(breaks = 1:12) + 
    geom_point(size = 3, position = position_dodge(0.5)) +
    geom_errorbar(aes(ymin = NU.CI.L, ymax = NU.CI.U), 
                  size = 1.25, width = 0.4, position = position_dodge(0.5)) +
    ...
    labs(title = "Non-urban",
         x = "Month", y = "No. of cells")) +
  plot_layout(guides = "collect") +
  plot_annotation(title = "Birding effort in grid cells at 2kmx2km resolution",
