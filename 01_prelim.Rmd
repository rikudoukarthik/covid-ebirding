...
groupaccspath <- "data/ebd_users_GA_relSep-2021.csv"
...
writeRaster(rast_aoi, paste0(MODISpath, "/in_LULC_MODIS.tif"), overwrite = TRUE)
...
rast_UNU <- reclassify(rast, rcl = reclass)
plot(rast_UNU)
