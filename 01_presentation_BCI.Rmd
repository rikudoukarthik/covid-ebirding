...
date: '`r format(dmy("17/11/2021"), "%d-%m-%Y")`'
output:
...
.pull-left[
```{r t_spread_1, cache=TRUE, dependson="setup", message=FALSE, echo=FALSE}
...
.pull-right[
```{r t_spread_2, cache=TRUE, dependson="setup", message=FALSE, echo=FALSE}
