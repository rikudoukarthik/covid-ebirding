...
```{r b_overall_s1, cache=TRUE, message=FALSE}

anal_name <- "b_overall_s1"

b_overall_annual("Karnataka")

save(data_a, data_b, file = glue("00_outputs/{anal_name}.RData"))
...
```{r b_overall_s1_model, cache=TRUE, message=FALSE}

anal_name <- "b_overall_s1_model"
...
```{r b_overall_s2, cache=TRUE, message=FALSE}

anal_name <- "b_overall_s2"

b_overall_annual("Kerala")
...
```{r b_overall_s2c_model, cache=TRUE, message=FALSE}

anal_name <- "b_overall_s2_model"
state_name <- "Kerala"
...
```{r b_overall_s3, cache=TRUE, message=FALSE}


anal_name <- "b_overall_s3"

b_overall_annual("Maharashtra")
...
```{r b_overall_s3c_model, cache=TRUE, message=FALSE}

anal_name <- "b_overall_s3_model"
...
```{r b_overall_s4, cache=TRUE, message=FALSE}

anal_name <- "b_overall_s4"

b_overall_annual("Assam")
...
```{r b_overall_s4c_model, cache=TRUE, message=FALSE}

anal_name <- "b_overall_s4_model"
state_name <- "Assam"
