...
data_a <- data0_MY_slice_S %>% 
  ...
  ungroup() %>% 
  # filling zeroes for M.YEAR-MONTH combos where observer had no list
  complete(OBSERVER.ID, nesting(M.YEAR, MONTH),
           fill = list(NO.SITES = 0))
