...
load("data/maps_gridmapg1_IN.RData") # all cells in India
...
##### Final analysis (map): cluster and outlier analysis with local Moran's I ####
...
clust_map_all <- ggplot(clust_data) +
  geom_polygon(data = indiamap,
               aes(long, lat, group = group),
               colour = "black", fill = "#E6E9F1", size = 0.2) +
...
ggsave("03_wrap_figs/10c_s_spread_clust_map_all.png", clust_map_all,
       width = 24, height = 9, units = "in", dpi = 300)



clust_map <- ggplot(clust_data) +
  geom_polygon(data = indiamap,
               aes(long, lat, group = group),
               colour = "black", fill = "#E6E9F1", size = 0.2) +
  facet_wrap(~ COVID, nrow = 1) +
...
ggsave("03_wrap_figs/10c_s_spread_clust_map.png", clust_map,
       width = 24, height = 9, units = "in", dpi = 300)
