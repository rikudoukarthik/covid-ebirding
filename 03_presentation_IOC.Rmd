...
hotspot_hide + 
  ...
  geom_point(size = 3, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.5, width = 0.4, position = position_dodge(0.5)) -> hotspot
...
[`r fontawesome::fa("twitter")` @TrickDEerie](https://twitter.com/TrickDEerie)  
[`r fontawesome::fa("link")` kartrick.rbind.io](https://kartrick.rbind.io)  
[`r fontawesome::fa("paper-plane")` karthik.t@ncf-india.org](mailto:karthik.t@ncf-india.org)
]
