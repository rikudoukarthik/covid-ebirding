...
8.  *List length*: List length is defined as the total number of species observed in a checklist. Using this metric, we approached from a different angle the question of whether checklists became shorter during the pandemic.
