...
Very minor suggestions of changes during the 2 month period in a few species, but overall no pattern. At the larger spatial scale, wetland species show some differences, but others show no overall change in reporting frequency due to the pandemic.
