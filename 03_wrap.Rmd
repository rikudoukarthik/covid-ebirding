...
bang1 <- glm(REP.FREQ ~ M.YEAR + poly(MONTH, 2) + SP.CATEGORY +
...
bang3 <- glm(REP.FREQ ~ M.YEAR + SP.CATEGORY + M.YEAR:SP.CATEGORY,
               data = data_b, family = binomial(), weights = TOT.LISTS)

summary(bang3)
AIC(bang2) - AIC(bang1) # on 6 df. Definitely include month.
