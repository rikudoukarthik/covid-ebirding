...
```{r bang_01, cache=TRUE, message=FALSE}

# load("data/data0.RData")

species <- data.frame(
  COMMON.NAME = c("Red-whiskered Bulbul", "Common Tailorbird", "Black Kite",
                  "Jerdon's Bushlark", "Pied Bushchat", "Oriental Honey-buzzard"),
  SP.CATEGORY = c(rep("U", 3), rep("R", 3)))
...
( ((ggplot(filter(birds_monthly, COMMON.NAME == "Red-whiskered Bulbul"), 
       aes(MONTH, REP.FREQ, colour = COVID)) +
  geom_point(size = 3, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.25, width = 0.6, position = position_dodge(0.5)) +
  scale_x_continuous(breaks = 1:12) +
  scale_colour_manual(values = covid_palette) +
  labs(title = "Red-whiskered Bulbul",
       x = "Month", y = "Reporting frequency")) /
(ggplot(filter(birds_monthly, COMMON.NAME == "Common Tailorbird"), 
       aes(MONTH, REP.FREQ, colour = COVID)) +
  geom_point(size = 3, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.25, width = 0.6, position = position_dodge(0.5)) +
  scale_x_continuous(breaks = 1:12) +
  scale_colour_manual(values = covid_palette) +
  labs(title = "Common Tailorbird",
       x = "Month", y = "Reporting frequency")) /
(ggplot(filter(birds_monthly, COMMON.NAME == "Black Kite"), 
       aes(MONTH, REP.FREQ, colour = COVID)) +
  geom_point(size = 3, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.25, width = 0.6, position = position_dodge(0.5)) +
  scale_x_continuous(breaks = 1:12) +
  scale_colour_manual(values = covid_palette) +
  labs(title = "Black Kite",
       x = "Month", y = "Reporting frequency"))) |
((ggplot(filter(birds_monthly, COMMON.NAME == "Jerdon's Bushlark"), 
       aes(MONTH, REP.FREQ, colour = COVID)) +
  geom_point(size = 3, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.25, width = 0.6, position = position_dodge(0.5)) +
  scale_x_continuous(breaks = 1:12) +
  scale_colour_manual(values = covid_palette) +
  labs(title = "Jerdon's Bushlark",
       x = "Month", y = "Reporting frequency")) /
(ggplot(filter(birds_monthly, COMMON.NAME == "Pied Bushchat"), 
       aes(MONTH, REP.FREQ, colour = COVID)) +
  geom_point(size = 3, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.25, width = 0.6, position = position_dodge(0.5)) +
  scale_x_continuous(breaks = 1:12) +
  scale_colour_manual(values = covid_palette) +
  labs(title = "Pied Bushchat",
       x = "Month", y = "Reporting frequency")) /
(ggplot(filter(birds_monthly, COMMON.NAME == "Oriental Honey-buzzard"), 
       aes(MONTH, REP.FREQ, colour = COVID)) +
  geom_point(size = 3, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.25, width = 0.6, position = position_dodge(0.5)) +
  scale_x_continuous(breaks = 1:12) +
  scale_colour_manual(values = covid_palette) +
  labs(title = "Oriental Honey-buzzard",
       x = "Month", y = "Reporting frequency"))) ) +
plot_layout(guides = "collect") +
plot_annotation(title = "South Karnataka (south of 14 deg latitude; 254 cells)") -> b01_bang_monthly


ggsave("03_wrap_figs/b01_bang_monthly.png", b01_bang_monthly,
       width = 11, height = 10, units = "in", dpi = 300)


```

Some strange patterns are present, though nothing conclusively due to the pandemic and not in one particular direction. Do these patterns persist at the annual level?

```{r bang_02, cache=TRUE, message=FALSE}
...
birds <- data0_slice_G_MY %>% 
  filter(COUNTY == area, M.YEAR > 2018) %>% 
  ...
  summarise(TOT.LISTS = min(TOT.LISTS),
            NO.LISTS = n_distinct(GROUP.ID),
            REP.FREQ = round(NO.LISTS/TOT.LISTS, 4)) %>% 
  summarise(REP.FREQ = boot_conf(x = REP.FREQ)) %>% 
  group_by(COMMON.NAME, M.YEAR) %>% 
  summarise(CI.L = stats::quantile(REP.FREQ, 0.025), # Obtain the CIs
            CI.U = stats::quantile(REP.FREQ, 0.975),
            REP.FREQ = mean(REP.FREQ))

(((ggplot(filter(birds, COMMON.NAME == "Red-whiskered Bulbul"), 
       aes(x = M.YEAR, y = REP.FREQ)) + 
  geom_point(size = 4, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.75, width = 0.08, position = position_dodge(0.5)) +
...
(ggplot(filter(birds, COMMON.NAME == "Common Tailorbird"), 
       aes(x = M.YEAR, y = REP.FREQ)) + 
  geom_point(size = 4, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.75, width = 0.08, position = position_dodge(0.5)) +
  ...
  labs(title = "Common Tailorbird",
       x = "Migratory year", y = "Reporting frequency")) /
(ggplot(filter(birds, COMMON.NAME == "Black Kite"), 
       aes(x = M.YEAR, y = REP.FREQ)) + 
  geom_point(size = 4, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.75, width = 0.08, position = position_dodge(0.5)) +
  ...
  labs(title = "Black Kite",
       x = "Migratory year", y = "Reporting frequency"))) |
((ggplot(filter(birds, COMMON.NAME == "Jerdon's Bushlark"), 
       aes(x = M.YEAR, y = REP.FREQ)) + 
  geom_point(size = 4, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.75, width = 0.08, position = position_dodge(0.5)) +
  ...
  labs(title = "Jerdon's Bushlark",
       x = "Migratory year", y = "Reporting frequency")) /
(ggplot(filter(birds, COMMON.NAME == "Pied Bushchat"), 
       aes(x = M.YEAR, y = REP.FREQ)) + 
  geom_point(size = 4, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.75, width = 0.08, position = position_dodge(0.5)) +
  ...
  labs(title = "Pied Bushchat",
       x = "Migratory year", y = "Reporting frequency")) /
(ggplot(filter(birds, COMMON.NAME == "Oriental Honey-buzzard"), 
       aes(x = M.YEAR, y = REP.FREQ)) + 
  geom_point(size = 4, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.75, width = 0.08, position = position_dodge(0.5)) +
  ...
  labs(title = "Oriental Honey-buzzard",
       x = "Migratory year", y = "Reporting frequency")))) +
plot_annotation(title = "South Karnataka (south of 14 deg latitude; 254 cells)") -> b02_bang

ggsave("03_wrap_figs/b02_bang.png", b02_bang,
...
```{r soka_01, cache=TRUE, message=FALSE}

# load("data/data_UNU.RData")

birds_monthly <- data_UNU %>% 
  filter(LATITUDE < 14, STATE == "Karnataka") %>% 
  group_by(COVID, YEAR, MONTH, CELL.ID) %>% 
  summarise(GROUP.ID = GROUP.ID,
            SAMPLING.EVENT.IDENTIFIER = SAMPLING.EVENT.IDENTIFIER,
            TOT.LISTS = n_distinct(GROUP.ID)) %>% 
...
(ggplot(filter(birds_monthly, COMMON.NAME == "Oriental Honey-buzzard"), 
  ...
  labs(title = "Oriental Honey-buzzard",
       x = "Month", y = "Reporting frequency"))) ) +
plot_layout(guides = "collect") +
plot_annotation(title = "South Karnataka (south of 14 deg latitude; 254 cells)") -> b03_soka_monthly


ggsave("03_wrap_figs/b03_soka_monthly.png", b03_soka_monthly,
       width = 11, height = 10, units = "in", dpi = 300)


```

```{r soka_02, cache=TRUE, message=FALSE}

# adding migratory year column
data_UNU_MY <- data_UNU %>% 
  mutate(DAY.Y = yday(OBSERVATION.DATE),
         M.YEAR = if_else(DAY.Y <= 151, YEAR-1, YEAR)) # from 1st June to 31st May
         

birds <- data_UNU_MY %>% 
  filter(LATITUDE < 14, STATE == "Karnataka", M.YEAR > 2018) %>% 
  group_by(M.YEAR, CELL.ID, MONTH) %>% 
  summarise(YEAR = YEAR,
            GROUP.ID = GROUP.ID,
            SAMPLING.EVENT.IDENTIFIER = SAMPLING.EVENT.IDENTIFIER,
            TOT.LISTS = n_distinct(GROUP.ID)) %>% 
  left_join(data0) %>% 
  filter(COMMON.NAME %in% species$COMMON.NAME) %>% 
  group_by(COMMON.NAME, M.YEAR, CELL.ID, MONTH) %>% 
  summarise(TOT.LISTS = min(TOT.LISTS),
            NO.LISTS = n_distinct(GROUP.ID),
            REP.FREQ = round(NO.LISTS/TOT.LISTS, 4)) %>% 
  group_by(COMMON.NAME, M.YEAR) %>% 
...
(ggplot(filter(birds, COMMON.NAME == "Oriental Honey-buzzard"), 
  ...
  labs(title = "Oriental Honey-buzzard",
       x = "Migratory year", y = "Reporting frequency")))) +
plot_annotation(title = "South Karnataka (south of 14 deg latitude; 254 cells)") -> b04_soka

ggsave("03_wrap_figs/b04_soka.png", b04_soka,
       width = 10, height = 11, units = "in", dpi = 300)
...
```{r pun_01, cache=TRUE, message=FALSE}

species <- data.frame(
  COMMON.NAME = c("Red-whiskered Bulbul", "Common Tailorbird", "Black Kite",
                  "Common Iora", "Pied Bushchat", "Oriental Honey-buzzard"),
  SP.CATEGORY = c(rep("U", 3), rep("R", 3)))
...
(ggplot(filter(birds_monthly, COMMON.NAME == "Black Kite"), 
  ...
  labs(title = "Black Kite",
       x = "Month", y = "Reporting frequency"))) |
((ggplot(filter(birds_monthly, COMMON.NAME == "Common Iora"), 
       aes(MONTH, REP.FREQ, colour = COVID)) +
  geom_point(size = 3, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.25, width = 0.6, position = position_dodge(0.5)) +
...
(ggplot(filter(birds_monthly, COMMON.NAME == "Oriental Honey-buzzard"), 
  ...
  labs(title = "Oriental Honey-buzzard",
       x = "Month", y = "Reporting frequency"))) ) +
plot_layout(guides = "collect") -> b_pun_monthly

ggsave("03_wrap_figs/b_pun_monthly.png", b_pun_monthly,
       width = 11, height = 10, units = "in", dpi = 300)

```

Some patterns are present, like with PiBu decreasing during the peak pandemic. Do these patterns persist at the annual level?

```{r pun_02, cache=TRUE, message=FALSE}
...
(ggplot(filter(birds, COMMON.NAME == "Black Kite"), 
  ...
  labs(title = "Black Kite",
       x = "Migratory year", y = "Reporting frequency"))) |
((ggplot(filter(birds, COMMON.NAME == "Common Iora"), 
       aes(x = M.YEAR, y = REP.FREQ)) + 
  geom_point(size = 4, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.75, width = 0.08, position = position_dodge(0.5)) +
...
(ggplot(filter(birds, COMMON.NAME == "Oriental Honey-buzzard"), 
  ...
  labs(title = "Oriental Honey-buzzard",
       x = "Migratory year", y = "Reporting frequency")))) +
plot_annotation(title = "Pune county") -> b_pune

ggsave("03_wrap_figs/b_pune.png", b_pune,
       width = 10, height = 11, units = "in", dpi = 300)
