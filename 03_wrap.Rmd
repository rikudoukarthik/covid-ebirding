...
data_a <- data0_MY_slice_S %>% 
  ...
  dplyr::summarise(GROUP.BIRDING = if_else(NUMBER.OBSERVERS > 1, 1, 0)) %>%
  ungroup() 
...
ggplot(pred_a, aes(MONTH, PROP.G.PRED, colour = M.YEAR)) +
...
ggplot(pred_b, aes(MONTH, PROP.G.PRED, colour = M.YEAR)) +
...
ggplot(pred_c, aes(MONTH, PROP.G.PRED, colour = M.YEAR)) +
...
ggplot(pred_d, aes(MONTH, PROP.G.PRED, colour = M.YEAR)) +
