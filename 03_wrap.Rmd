...
rm(areag1, areag2, areag3, areag4, districtmap, statemap)
...
data_SoIBmap <- data_SoIBmap1 %>% 
  ...
  mutate(T1 = rast_logpropchange(BEF, DUR),
         T2 = rast_logpropchange(DUR, AFT),
         T3 = rast_logpropchange(BEF, AFT)) %>% 
...
ggplot(data_SoIBmap) +
  ...
  geom_sf(aes(fill = T.CHANGE), col = NA) +
  facet_wrap(~ T.LABEL) +
  scale_fill_viridis_c(option = "cividis") + 
  labs(x = "Longitude", y = "Latitude",
       title = "Proportional change in monthly (seven months) no. of lists per 24km \u00d7 24km cell")
