...
# Getting EBD data + filtering and preparing for current use (16 mins on server) ###
...
rm(data0_slice_G, data0_slice_S, data_UNU)
save(data0_slice_G_MY, file = "data/data0_slice_G_MY.RData")

# load("data/data0_slice_G_MY.RData")
