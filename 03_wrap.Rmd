...
```{r blr, cache=TRUE, message=FALSE}
...
data_bang <- data0_slice_G %>% 
  ...
  left_join(data0) %>% 
  filter(COMMON.NAME %in% species_bang$COMMON.NAME) %>% 
  ...
  group_by(COMMON.NAME, COVID, YEAR) %>% 
...
( ((ggplot(filter(data_bang, COMMON.NAME == "Red-whiskered Bulbul"), 
       aes(COVID, REP.FREQ, colour = COVID)) +
  geom_point(size = 3, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
...
(ggplot(filter(data_bang, COMMON.NAME == "Common Tailorbird"), 
  ...
  labs(title = "Common Tailorbird",
       x = "Month", y = "Reporting frequency")) /
(ggplot(filter(data_bang, COMMON.NAME == "Black Kite"), 
       aes(MONTH, REP.FREQ, colour = COVID)) +
  geom_point(size = 3, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.25, width = 0.6, position = position_dodge(0.5)) +
  ...
  labs(title = "Black Kite",
       x = "Month", y = "Reporting frequency"))) |
((ggplot(filter(data_bang, COMMON.NAME == "Jerdon's Bushlark"), 
       aes(MONTH, REP.FREQ, colour = COVID)) +
  geom_point(size = 3, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.25, width = 0.6, position = position_dodge(0.5)) +
  ...
  labs(title = "Jerdon's Bushlark",
       x = "Month", y = "Reporting frequency")) /
(ggplot(filter(data_bang, COMMON.NAME == "Pied Bushchat"), 
       aes(MONTH, REP.FREQ, colour = COVID)) +
  geom_point(size = 3, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.25, width = 0.6, position = position_dodge(0.5)) +
  ...
  labs(title = "Pied Bushchat",
       x = "Month", y = "Reporting frequency")) /
(ggplot(filter(data_bang, COMMON.NAME == "Oriental Honey-buzzard"), 
       aes(MONTH, REP.FREQ, colour = COVID)) +
  geom_point(size = 3, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.25, width = 0.6, position = position_dodge(0.5)) +
  ...
  labs(title = "Oriental Honey-buzzard",
       x = "Month", y = "Reporting frequency"))) ) +
plot_layout(guides = "collect") -> birds_blr

ggsave("03_wrap_figs/birds_blr.png", birds_blr,
...
```{r pun, cache=TRUE, message=FALSE}
...
data_pune <- data0_slice_G %>% 
  ...
  summarise(GROUP.ID = GROUP.ID,
            ...
            TOT.LISTS = n_distinct(GROUP.ID)) %>% 
  left_join(data0) %>% 
  filter(COMMON.NAME %in% species_pune$COMMON.NAME) %>% 
  group_by(COMMON.NAME, COVID, YEAR, MONTH) %>% 
  summarise(TOT.LISTS = min(TOT.LISTS),
            NO.LISTS = n_distinct(GROUP.ID),
            REP.FREQ = round(NO.LISTS/TOT.LISTS, 4),
...
( ((ggplot(filter(data_pune, COMMON.NAME == "Red-whiskered Bulbul"), 
       aes(MONTH, REP.FREQ, colour = COVID)) +
  geom_point(size = 3, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.25, width = 0.6, position = position_dodge(0.5)) +
  ...
  labs(title = "Red-whiskered Bulbul",
       x = "Month", y = "Reporting frequency")) /
(ggplot(filter(data_pune, COMMON.NAME == "Common Tailorbird"), 
       aes(MONTH, REP.FREQ, colour = COVID)) +
  geom_point(size = 3, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.25, width = 0.6, position = position_dodge(0.5)) +
  ...
  labs(title = "Common Tailorbird",
       x = "Month", y = "Reporting frequency")) /
(ggplot(filter(data_pune, COMMON.NAME == "Black Kite"), 
       aes(MONTH, REP.FREQ, colour = COVID)) +
  geom_point(size = 3, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.25, width = 0.6, position = position_dodge(0.5)) +
  ...
  labs(title = "Black Kite",
       x = "Month", y = "Reporting frequency"))) |
((ggplot(filter(data_pune, COMMON.NAME == "Common Iora"), 
       aes(MONTH, REP.FREQ, colour = COVID)) +
  geom_point(size = 3, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.25, width = 0.6, position = position_dodge(0.5)) +
  ...
  labs(title = "Common Iora",
       x = "Month", y = "Reporting frequency")) /
(ggplot(filter(data_pune, COMMON.NAME == "Pied Bushchat"), 
       aes(MONTH, REP.FREQ, colour = COVID)) +
  geom_point(size = 3, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.25, width = 0.6, position = position_dodge(0.5)) +
  ...
  labs(title = "Pied Bushchat",
       x = "Month", y = "Reporting frequency")) /
(ggplot(filter(data_pune, COMMON.NAME == "Oriental Honey-buzzard"), 
       aes(MONTH, REP.FREQ, colour = COVID)) +
  geom_point(size = 3, position = position_dodge(0.5)) +
  geom_errorbar(aes(ymin = CI.L, ymax = CI.U), 
                size = 1.25, width = 0.6, position = position_dodge(0.5)) +
  ...
  labs(title = "Oriental Honey-buzzard",
       x = "Month", y = "Reporting frequency"))) ) +
plot_layout(guides = "collect") -> birds_pun

ggsave("03_wrap_figs/birds_pun.png", birds_pun,
       width = 11, height = 10, units = "in", dpi = 300)
