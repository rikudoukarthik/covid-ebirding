...
# making function to supply in raster::aggregate() with 25% threshold for "urban" ( https://stackoverflow.com/questions/23369579/aggregate-raster-in-r-with-na-values )
...
```{r s_UNU_lists, cache=TRUE, message=FALSE}
...
(ggplot(filter(urban_sw, STATE == "Maharashtra"), 
    ...
    labs(title = "Maharashtra",
         x = "Month", y = "Proportion of urban lists"))) +
plot_layout(guides = "collect") +
plot_annotation(title = "Change in proportion of checklists in urban and non-urban cells (2kmx2km) with the pandemic") -> s_UNU_lists


ggsave("02_explor_figs/12_s_UNU_lists.png", 
       plot = s_UNU_lists,
       width = 9, height = 9, units = "in")
