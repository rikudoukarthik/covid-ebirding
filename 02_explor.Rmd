...
plot_annotation(title = "What proportion of checklists were from urban areas (2kmx2km cells)?") -> s_UNU_lists
...
# using only months for which data from all 3 COVID categories is present
...
(ggplot() +
  ...
  scale_fill_distiller(palette = "Reds", direction = 1) +
  labs(title = "AFT_21")) +
plot_layout(guides = "collect") -> s_spread
