...
rast_SoIBmap <- raster::stack(
  ...
  raster::overlay(x = rast_SoIBmap1, y = rast_SoIBmap3, 
                               fun = rast_logpropchange))
names(rast_SoIBmap) <- c("COVID", "After", "BeforeAfter")
...
levelplot(rast_SoIBmap, 
          ...
          margin = F, 
          at = seq(cellStats(rast_SoIBmap, "min"), 
                   cellStats(rast_SoIBmap, "max"), 
                   length.out = 201),
...
# rasterVis::gplot(rast_SoIBmap) + geom_tile(aes(fill = value))
