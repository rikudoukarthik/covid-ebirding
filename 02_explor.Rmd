...
levelplot(data_map, 
          ...
          margin = F, 
          at = seq(cellStats(data_map, "min"), 
                   cellStats(data_map, "max"), 
                   length.out = 201),
          main = "Log prop. change in monthly (select months) no. of lists per 25kmx25km cell") +
  latticeExtra::layer(sp::sp.polygons(in_bound, lwd = 1, col = "grey"))
