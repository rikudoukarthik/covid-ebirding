...
re_var03 <- get_re_vars(d03_time_po)
...
```{r model-summ9, eval.after = "tab.cap", tab.cap=glue('Model summary for birding time at the national level. Numerical years refer to "migratory years". Random effect variance of Observer ID is {re_var03}. See model specifications described earlier.'), out.width="100%"}

model_a <- d03_time_po %>% pluck(3)
