...
The recent anthropause has had impacts on not just human life but also wildlife. In many cases across North America and Europe, birds seemed to respond at short time scales and produce changes in aspects of their behaviour (e.g., song, detectability), abundance or even occurrence, and there were even indirect consequences on their fitness or survival. However, there was no strong, clear and consistent trend in either the positive or the negative direction, suggesting that the relationships between birds and human activity are complex and context-dependent. Given this precedent to expect discordant results in India, we explored two aspects of pandemic effects on bird species reporting, to determine whether patterns found elsewhere also exist in India. In the context of abundance trends estimation using citizen science (eBird) data in India, we compared patterns of modelled reporting frequencies for select species between the different years, to examine whether they were predictably different from the previous and next years, due to changes in either birdwatcher behaviour (or birdwatching effort), or bird abundance (which is a combination of true abundance and detectability). We did not find a direct impact of the pandemic on large-scale patterns of bird species reporting, despite high variability at finer scales. We also found no clear evidence of bird communities becoming more or less abundant during the pandemic. After accounting for differential effort expended in data collection which could have generated artefactual patterns, there was no evidence of urban bird species being reported more frequently than rural ones. That is, at the large scale, the pandemic changed neither the kinds of species (urban vs rural) birdwatchers were observing nor the true abundance or detectability of these species groups. Reasons for this could pertain to the types of information eBird is and is not able to provide, as well as India's uniqueness with respect to features of such data. Thus, our findings reiterate the difficulty in making global generalisations as well as the importance of context-appropriate analyses.
...
Aside from this urban bias, most other changes to birder behaviour, and therefore effort, in India were restricted to a small number of months during the peak pandemic period, and these did not translate over to larger scales such as years [@thrikkadeeriCOVIDp1]. Spatially, there was no specific pattern that was consistent across individual units or scales. Aside from contributing to advancement of ornithological knowledge in other ways [@thrikkadeerietalWHBW], birders can also help maintain citizen science data quality by means of their resilience to perturbations such as the pandemic [@thrikkadeeriCOVIDp1].
