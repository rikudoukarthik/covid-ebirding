...
load("00_outputs/b_overall_s1a_m.RData")
...
load("00_outputs/b_overall_s1b_y.RData")
d1 <- data_a %>% ungroup() %>% filter(SP.CATEGORY == "U") %>% 
...
load("00_outputs/b_overall_s2a_m.RData")
d1 <- data_a %>% ungroup() %>% filter(SP.CATEGORY == "U") %>% 
  left_join(month_lab) %>% arrange(M.YEAR, MONTH.LAB)
d2 <- data_a %>% ungroup() %>% filter(SP.CATEGORY == "R") %>% 
  left_join(month_lab) %>% arrange(M.YEAR, MONTH.LAB)
...
load("00_outputs/b_overall_s2b_y.RData")
d1 <- data_a %>% ungroup() %>% filter(SP.CATEGORY == "U") %>% 
  left_join(month_lab) %>% arrange(M.YEAR)
d2 <- data_a %>% ungroup() %>% filter(SP.CATEGORY == "R") %>% 
  left_join(month_lab) %>% arrange(M.YEAR)
...
load("00_outputs/b_overall_s3a_m.RData")
d1 <- data_a %>% ungroup() %>% filter(SP.CATEGORY == "U") %>% 
  left_join(month_lab) %>% arrange(M.YEAR, MONTH.LAB)
d2 <- data_a %>% ungroup() %>% filter(SP.CATEGORY == "R") %>% 
  left_join(month_lab) %>% arrange(M.YEAR, MONTH.LAB)
...
load("00_outputs/b_overall_s3b_y.RData")
d1 <- data_a %>% ungroup() %>% filter(SP.CATEGORY == "U") %>% 
  left_join(month_lab) %>% arrange(M.YEAR)
d2 <- data_a %>% ungroup() %>% filter(SP.CATEGORY == "R") %>% 
  left_join(month_lab) %>% arrange(M.YEAR)
...
load("00_outputs/b_overall_s4a_m.RData")
d1 <- data_b %>% ungroup() %>% filter(SP.CATEGORY == "U") %>% 
  left_join(month_lab) %>% arrange(M.YEAR, MONTH.LAB)
d2 <- data_b %>% ungroup() %>% filter(SP.CATEGORY == "R") %>% 
  left_join(month_lab) %>% arrange(M.YEAR, MONTH.LAB)
...
load("00_outputs/b_overall_s4b_y.RData")
d1 <- data_b %>% ungroup() %>% filter(SP.CATEGORY == "U") %>% 
  left_join(month_lab) %>% arrange(M.YEAR)
d2 <- data_b %>% ungroup() %>% filter(SP.CATEGORY == "R") %>% 
  left_join(month_lab) %>% arrange(M.YEAR)
